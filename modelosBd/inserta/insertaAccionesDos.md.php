		...
		case "recomendadoUni":
				...
				if ($fisicamenteEn==1) {
					...
					if ($infraesPosesivos=="si") {
						$documento=$objeto->getEnviarPdf($_FILES["pdfArchivos"]['type'],$_FILES["pdfArchivos"]['size'],$_FILES["pdfArchivos"]['tmp_name'],$_FILES["pdfArchivos"]['name'],"../../documentos/informeInfraSeparado/",$nombrePdf);
					}
