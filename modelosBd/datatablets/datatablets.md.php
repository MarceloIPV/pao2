<?php
	...
	switch ($identificador) {
		...
		case "tablaTipoOrganizacion":
			...
			$query="SELECT a.nombreTipoOrganismo,(SELECT REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(a1.nombreArea, 'Ã¡', 'á'),'Ã©','é'),'Ã­','í'),'Ã³','ó'),'Ãº','ú'),'Ã‰','É'),'ÃŒ','Í'),'Ã“','Ó'),'Ãš','Ú'),'Ã±','ñ'),'Ã‘','Ñ'),'&#039;',' ` '),'Ã','Á'),'',' '),'Ã','Á'),'SI','SI'),'â€œ',''),'â€',''),'Á²','ó')  FROM poa_areaencargada AS a1 WHERE a1.idAreaEncargada=a.idArea LIMIT 1) AS areaEncargada,(SELECT REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(a1.accion, 'Ã¡', 'á'),'Ã©','é'),'Ã­','í'),'Ã³','ó'),'Ãº','ú'),'Ã‰','É'),'ÃŒ','Í'),'Ã“','Ó'),'Ãš','Ú'),'Ã±','ñ'),'Ã‘','Ñ'),'&#039;',' ` '),'Ã','Á'),'',' '),'Ã','Á'),'SI','SI'),'â€œ',''),'â€',''),'Á²','ó')  FROM poa_area_accion AS a1 WHERE a1.idAreaAccion=a.idAccion LIMIT 1) AS nombreAccion,a.idArea,a.idAccion,a.idTipoOrganismo FROM poa_paid_tipo_organismo AS a WHERE a.identificador='$datos[1]' OR a.identificador IS NULL;";
		...
		case "tablaItem__paid":
			...
			$query="SELECT REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(nombreItem, 'Ã¡', 'á'),'Ã©','é'),'Ã­','í'),'Ã³','ó'),'Ãº','ú'),'Ã‰','É'),'ÃŒ','Í'),'Ã“','Ó'),'Ãš','Ú'),'Ã±','ñ'),'Ã‘','Ñ'),'&#039;',' ` '),'Ã','Á'),'',' '),'Ã','Á'),'SI','SI'),'â€œ',''),'â€',''),'Á²','ó') AS nombreItem,itemPreesupuestario,idItem FROM poa_item WHERE identificador='$datos[1]' OR identificador IS NULL ORDER BY idItem DESC;";
		...
		case "tablaComponente":
			...
			$query="SELECT nombreComponentes,idComponentes FROM poa_paid_componentes WHERE identificador='$datos[1]';";
		...
		case "seguimiento__bloqueosTablaTrimestres__2":
			...
			$query="SELECT a.ruc,REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(a.nombreOrganismo, 'Ã¡', 'á'),'Ã©','é'),'Ã­','í'),'Ã³','ó'),'Ãº','ú'),'Ã‰','É'),'ÃŒ','Í'),'Ã“','Ó'),'Ãš','Ú'),'Ã±','ñ'),'Ã‘','Ñ'),'&#039;',' ` '),'Ã','Á'),'',' '),'Ã','Á'),'SI','SI'),'â€œ',''),'â€',''),'Á²','ó') AS nombreOrganismo,(SELECT a2.nombreProvincia FROM poa_organismo AS a1 INNER JOIN in_md_provincias AS a2 ON a1.idProvincia=a2.idProvincia WHERE a1.idOrganismo=a.idOrganismo) AS provincia,(SELECT a2.nombreCanton FROM poa_organismo AS a1 INNER JOIN in_md_canton AS a2 ON a1.idCanton=a2.idCanton WHERE a1.idOrganismo=a.idOrganismo) AS nombreCanton,(SELECT a2.nombreParroquia FROM poa_organismo AS a1 INNER JOIN in_md_parroquia AS a2 ON a1.idParroquia=a2.idParroquia WHERE a1.idOrganismo=a.idOrganismo) AS nombreParroquia,a.idOrganismo,(SELECT a1.estado FROM poa_cierre_fiscal AS a1 WHERE a1.periodo='$aniosPeriodos__ingesos' AND a.idOrganismo=a1.idOrganismo) AS estado,(SELECT a1.estado FROM poa_cierre_fiscal_paid AS a1 WHERE a1.periodo='$aniosPeriodos__ingesos' AND a.idOrganismo=a1.idOrganismo) AS estado2,(SELECT a1.motivo FROM poa_cierre_fiscal AS a1 WHERE a1.periodo='$aniosPeriodos__ingesos' AND a.idOrganismo=a1.idOrganismo) AS motivo,(SELECT a1.motivo FROM poa_cierre_fiscal_paid AS a1 WHERE a1.periodo='$aniosPeriodos__ingesos' AND a.idOrganismo=a1.idOrganismo) AS motivo2,(SELECT a1.estado FROM poa_cierre_fiscal_transferencia AS a1 WHERE a1.periodo='$aniosPeriodos__ingesos' AND a.idOrganismo=a1.idOrganismo) AS estad3,(SELECT a1.estado FROM poa_cierre_fiscal_paid_modificaciones AS a1 WHERE a1.periodo='$aniosPeriodos__ingesos' AND a.idOrganismo=a1.idOrganismo) AS estad4,(SELECT a1.motivo FROM poa_cierre_fiscal_transferencia AS a1 WHERE a1.periodo='$aniosPeriodos__ingesos' AND a.idOrganismo=a1.idOrganismo) AS motivo3,(SELECT a1.motivo FROM poa_cierre_fiscal_paid_modificaciones AS a1 WHERE a1.periodo='$aniosPeriodos__ingesos' AND a.idOrganismo=a1.idOrganismo) AS motivo4 FROM poa_organismo AS a;";
		...
		case "seguimiento__reportes__anexos":
			...
			$query="SELECT (SELECT a1.ruc FROM poa_organismo AS a1 WHERE a1.idOrganismo=a.idOrganismo) AS rucOrganismo,(SELECT REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(a1.nombreOrganismo, 'Ã¡', 'á'),'Ã©','é'),'Ã­','í'),'Ã³','ó'),'Ãº','ú'),'Ã‰','É'),'ÃŒ','Í'),'Ã“','Ó'),'Ãš','Ú'),'Ã±','ñ'),'Ã‘','Ñ'),'&#039;',' ` '),'Ã','Á'),'',' '),'Ã','Á'),'SI','SI'),'â€œ',''),'â€',''),'Á²','ó') FROM poa_organismo AS a1 WHERE a1.idOrganismo=a.idOrganismo) AS nombreOrganismo,CONCAT_WS('------',IF(a.tipoTrimestre='primerTrimestre' AND a.estado='T' AND a.perioIngreso='$aniosPeriodos__ingesos',(SELECT a1.documentos FROM poa_seguimiento_recomendado_tecnico_seguimientos AS a1 WHERE a1.idOrganismo=a.idOrganismo AND a1.trimestre='primerTrimestre' AND YEAR(a1.fecha)='2022' ORDER BY a1.idSeguimientosRecomendadosTe DESC LIMIT 1),'N/A'),IF(a.tipoTrimestre='primerTrimestre' AND (a.estadoAl='T' OR a.estadoF='T') AND a.perioIngreso='$aniosPeriodos__ingesos',(SELECT a1.archivo FROM poa_seguimiento_recomendado_tecnico AS a1 WHERE a1.idOrganismo=a.idOrganismo AND a1.trimestre='primerTrimestre' AND YEAR(a1.fecha)='2022' ORDER BY a1.idInformacionEnviada DESC LIMIT 1),'N/A'),IF(a.tipoTrimestre='primerTrimestre' AND a.estadoI='T' AND a.perioIngreso='$aniosPeriodos__ingesos',(SELECT a1.documentoInfras FROM poa_seguimiento_recomienda_tecnicos AS a1 WHERE a1.idOrganismo=a.idOrganismo AND a1.trimestre='primerTrimestre' AND YEAR(a1.fecha)='2022' AND a1.tipoE='INFRA' ORDER BY a1.idRecomendacionFuncionario DESC LIMIT 1),'N/A')) AS documentosPrimerTrimestre,CONCAT_WS('------',IF(a.tipoTrimestre='segundoTrimestre' AND a.estado='T' AND a.perioIngreso='$aniosPeriodos__ingesos',(SELECT a1.documentos FROM poa_seguimiento_recomendado_tecnico_seguimientos AS a1 WHERE a1.idOrganismo=a.idOrganismo AND a1.trimestre='segundoTrimestre' AND YEAR(a1.fecha)='2022' ORDER BY a1.idSeguimientosRecomendadosTe DESC LIMIT 1),'N/A'),IF(a.tipoTrimestre='segundoTrimestre' AND (a.estadoAl='T' OR a.estadoF='T') AND a.perioIngreso='$aniosPeriodos__ingesos',(SELECT a1.archivo FROM poa_seguimiento_recomendado_tecnico AS a1 WHERE a1.idOrganismo=a.idOrganismo AND a1.trimestre='segundoTrimestre' AND YEAR(a1.fecha)='2022' ORDER BY a1.idInformacionEnviada DESC LIMIT 1),'N/A'),IF(a.tipoTrimestre='segundoTrimestre' AND a.estadoI='T' AND a.perioIngreso='$aniosPeriodos__ingesos',(SELECT a1.documentoInfras FROM poa_seguimiento_recomienda_tecnicos AS a1 WHERE a1.idOrganismo=a.idOrganismo AND a1.trimestre='segundoTrimestre' AND YEAR(a1.fecha)='2022' AND a1.tipoE='INFRA' ORDER BY a1.idRecomendacionFuncionario DESC LIMIT 1),'N/A')) AS documentosSegundoTrimestre,CONCAT_WS('------',IF(a.tipoTrimestre='tercerTrimestre' AND a.estado='T' AND a.perioIngreso='$aniosPeriodos__ingesos',(SELECT a1.documentos FROM poa_seguimiento_recomendado_tecnico_seguimientos AS a1 WHERE a1.idOrganismo=a.idOrganismo AND a1.trimestre='tercerTrimestre' AND YEAR(a1.fecha)='2022' ORDER BY a1.idSeguimientosRecomendadosTe DESC LIMIT 1),'N/A'),IF(a.tipoTrimestre='tercerTrimestre' AND (a.estadoAl='T' OR a.estadoF='T') AND a.perioIngreso='$aniosPeriodos__ingesos',(SELECT a1.archivo FROM poa_seguimiento_recomendado_tecnico AS a1 WHERE a1.idOrganismo=a.idOrganismo AND a1.trimestre='segundoTrimestre' AND YEAR(a1.fecha)='2022' ORDER BY a1.idInformacionEnviada DESC LIMIT 1),'N/A'),IF(a.tipoTrimestre='tercerTrimestre' AND a.estadoI='T' AND a.perioIngreso='$aniosPeriodos__ingesos',(SELECT a1.documentoInfras FROM poa_seguimiento_recomienda_tecnicos AS a1 WHERE a1.idOrganismo=a.idOrganismo AND a1.trimestre='tercerTrimestre' AND YEAR(a1.fecha)='2022' AND a1.tipoE='INFRA' ORDER BY a1.idRecomendacionFuncionario DESC LIMIT 1),'N/A')) AS documentosTercerTrimestre,CONCAT_WS('------',IF(a.tipoTrimestre='cuartoTrimestre' AND a.estado='T' AND a.perioIngreso='$aniosPeriodos__ingesos',(SELECT a1.documentos FROM poa_seguimiento_recomendado_tecnico_seguimientos AS a1 WHERE a1.idOrganismo=a.idOrganismo AND a1.trimestre='cuartoTrimestre' AND YEAR(a1.fecha)='2022' ORDER BY a1.idSeguimientosRecomendadosTe DESC LIMIT 1),'N/A'),IF(a.tipoTrimestre='cuartoTrimestre' AND (a.estadoAl='T' OR a.estadoF='T') AND a.perioIngreso='$aniosPeriodos__ingesos',(SELECT a1.archivo FROM poa_seguimiento_recomendado_tecnico AS a1 WHERE a1.idOrganismo=a.idOrganismo AND a1.trimestre='cuartoTrimestre' AND YEAR(a1.fecha)='2022' ORDER BY a1.idInformacionEnviada DESC LIMIT 1),'N/A'),IF(a.tipoTrimestre='cuartoTrimestre' AND a.estadoI='T' AND a.perioIngreso='$aniosPeriodos__ingesos',(SELECT a1.documentoInfras FROM poa_seguimiento_recomienda_tecnicos AS a1 WHERE a1.idOrganismo=a.idOrganismo AND a1.trimestre='cuartoTrimestre' AND YEAR(a1.fecha)='2022' AND a1.tipoE='INFRA' ORDER BY a1.idRecomendacionFuncionario DESC LIMIT 1),'N/A')) AS documentosCuartoTrimestre,(SELECT IF(a3.accion='Deporte','FORMATIVO',IF(a3.accion='RecreaciÃ³n','RECREACION','ALTO RENDIMIENTO')) FROM poa_competencia_organismo_competencia AS a1 INNER JOIN poa_tipo_organismo AS a2 ON a1.idTipoOrganismo=a2.idTipoOrganismo INNER JOIN poa_area_accion AS a3 ON a3.idAreaAccion=a2.idAreaAccion WHERE a1.idOrganismo=a.idOrganismo ORDER BY a1.idCompetenciaOrganismo LIMIT 1) AS tiposFormativos,a.idOrganismo,YEAR(a.fecha) AS anio FROM poa_trimestrales AS a  GROUP BY a.idOrganismo;";
		...
		case "seguimiento__tablas__seguimientos__recomendados":
			...
			$query="SELECT b.ruc,REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(b.nombreOrganismo, 'Ã¡', 'á'),'Ã©','é'),'Ã­','í'),'Ã³','ó'),'Ãº','ú'),'Ã‰','É'),'ÃŒ','Í'),'Ã“','Ó'),'Ãš','Ú'),'Ã±','ñ'),'Ã‘','Ñ'),'&#039;',' ` '),'Ã','Á'),'',' '),'Ã','Á'),'SI','SI'),'â€œ',''),'â€',''),'Á²','ó') AS nombreOrganismo,a.tipoTrimestre,if(e.idAreaAccion=13,'RECREACION','FORMATIVO') AS rotuloRecreativos,a.idOrganismo,REPLACE(a.tipoTrimestre,'Trimestre',' ') AS trimestreT,REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(d.nombreTipo, 'Ã¡', 'á'),'Ã©','é'),'Ã­','í'),'Ã³','ó'),'Ãº','ú'),'Ã‰','É'),'ÃŒ','Í'),'Ã“','Ó'),'Ãš','Ú'),'Ã±','ñ'),'Ã‘','Ñ'),'&#039;',' ` '),'Ã','Á'),'',' '),'Ã','Á'),'SI','SI'),'â€œ',''),'â€',''),'Á²','ó') AS nombreTipo FROM poa_trimestrales AS a INNER JOIN poa_organismo AS b ON a.idOrganismo=b.idOrganismo INNER JOIN poa_competencia_organismo_competencia AS c ON c.idOrganismo=a.idOrganismo INNER JOIN poa_tipo_organismo AS d ON d.idTipoOrganismo=c.idTipoOrganismo INNER JOIN poa_area_accion AS e ON e.idAreaAccion=d.idAreaAccion WHERE a.estadoR='$datos[0]' AND a.perioIngreso='$aniosPeriodos__ingesos';";
		...
		case "seguimiento__tablas__fisica__rendimientos__recomendados":
			...
			$query="SELECT b.ruc,REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(b.nombreOrganismo, 'Ã¡', 'á'),'Ã©','é'),'Ã­','í'),'Ã³','ó'),'Ãº','ú'),'Ã‰','É'),'ÃŒ','Í'),'Ã“','Ó'),'Ãš','Ú'),'Ã±','ñ'),'Ã‘','Ñ'),'&#039;',' ` '),'Ã','Á'),'',' '),'Ã','Á'),'SI','SI'),'â€œ',''),'â€',''),'Á²','ó') AS nombreOrganismo,a.tipoTrimestre,if(e.idAreaAccion=13,'RECREACION','FORMATIVO') AS rotuloRecreativos,a.idOrganismo,REPLACE(a.tipoTrimestre,'Trimestre',' ') AS trimestreT,REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(d.nombreTipo, 'Ã¡', 'á'),'Ã©','é'),'Ã­','í'),'Ã³','ó'),'Ãº','ú'),'Ã‰','É'),'ÃŒ','Í'),'Ã“','Ó'),'Ãš','Ú'),'Ã±','ñ'),'Ã‘','Ñ'),'&#039;',' ` '),'Ã','Á'),'',' '),'Ã','Á'),'SI','SI'),'â€œ',''),'â€',''),'Á²','ó') AS nombreTipo FROM poa_trimestrales AS a INNER JOIN poa_organismo AS b ON a.idOrganismo=b.idOrganismo INNER JOIN poa_competencia_organismo_competencia AS c ON c.idOrganismo=a.idOrganismo INNER JOIN poa_tipo_organismo AS d ON d.idTipoOrganismo=c.idTipoOrganismo INNER JOIN poa_area_accion AS e ON e.idAreaAccion=d.idAreaAccion WHERE a.estadoFR='$datos[0]' AND a.perioIngreso='$aniosPeriodos__ingesos';";
		...
		case "reporteria__actividades__4":
			...
			if (empty($idOrganismo)) {
				...
				$query="SELECT REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(z.nombreItem, 'Ã¡', 'á'),'Ã©','é'),'Ã­','í'),'Ã³','ó'),'Ãº','ú'),'Ã‰','É'),'ÃŒ','Í'),'Ã“','Ó'),'Ãš','Ú'),'Ã±','ñ'),'Ã‘','Ñ'),'&#039;',' ` '),'Ã','Á'),'',' '),'Ã','Á'),'SI','SI'),'â€œ',''),'â€',''),'Á²','ó') AS nombreItem,a.tipoFinanciamiento,a.nombreEvento,(SELECT a1.nombreDeporte FROM poa_deporte AS a1 WHERE a1.idDeporte=a.Deporte) AS nombreDeporte,(SELECT a1.nombreProvincia FROM in_md_provincias AS a1 WHERE a1.idProvincia=a.provincia) AS nombreProvincia,(SELECT a1.paisnombre FROM poa_pais AS a1 WHERE a1.id=a.ciudadPais) AS paisNombre, (SELECT a1.nombreAlcanse FROM poa_alcanse AS a1 WHERE a1.idAlcanse=a.alcance) AS alcance,a.fechaInicio,a.fechaFin,a.genero,a.categoria,a.numeroEntreandores,a.numeroAtletas,a.total,a.mBenefici,a.hBenefici,a.justificacionAd,a.canitdarBie,a.detalleBien,a.enero,a.febrero,a.marzo,a.abril,a.mayo,a.junio,a.julio,a.agosto,a.septiembre,a.octubre,a.noviembre,a.diciembre,a.totalElem FROM poa_actdeportivas AS a INNER JOIN poa_programacion_financiera AS b ON a.idProgramacionFinanciera=b.idProgramacionFinanciera INNER JOIN poa_item AS z ON z.idItem=b.idItem WHERE b.idOrganismo='$datos[0]' AND b.idActividad='4' AND a.perioIngreso='$aniosPeriodos__ingesos' ORDER BY idActividad;";
		...
		case "reporteria__actividades__5":
			...
			if (empty($idOrganismo)) {
				...
				$query="SELECT REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(z.nombreItem, 'Ã¡', 'á'),'Ã©','é'),'Ã­','í'),'Ã³','ó'),'Ãº','ú'),'Ã‰','É'),'ÃŒ','Í'),'Ã“','Ó'),'Ãš','Ú'),'Ã±','ñ'),'Ã‘','Ñ'),'&#039;',' ` '),'Ã','Á'),'',' '),'Ã','Á'),'SI','SI'),'â€œ',''),'â€',''),'Á²','ó') AS nombreItem,a.tipoFinanciamiento,a.nombreEvento,(SELECT a1.nombreDeporte FROM poa_deporte AS a1 WHERE a1.idDeporte=a.Deporte) AS nombreDeporte,(SELECT a1.nombreProvincia FROM in_md_provincias AS a1 WHERE a1.idProvincia=a.provincia) AS nombreProvincia,(SELECT a1.paisnombre FROM poa_pais AS a1 WHERE a1.id=a.ciudadPais) AS paisNombre, (SELECT a1.nombreAlcanse FROM poa_alcanse AS a1 WHERE a1.idAlcanse=a.alcance) AS alcance,a.fechaInicio,a.fechaFin,a.genero,a.categoria,a.numeroEntreandores,a.numeroAtletas,a.total,a.mBenefici,a.hBenefici,a.justificacionAd,a.canitdarBie,a.detalleBien,a.enero,a.febrero,a.marzo,a.abril,a.mayo,a.junio,a.julio,a.agosto,a.septiembre,a.octubre,a.noviembre,a.diciembre,a.totalElem FROM poa_actdeportivas AS a INNER JOIN poa_programacion_financiera AS b ON a.idProgramacionFinanciera=b.idProgramacionFinanciera INNER JOIN poa_item AS z ON z.idItem=b.idItem WHERE b.idOrganismo='$datos[0]' AND b.idActividad='5' AND a.perioIngreso='$aniosPeriodos__ingesos' ORDER BY idActividad;";
		...
		case "reporteria__actividades__6":
			...
			if (empty($idOrganismo)) {
				...
				$query="SELECT REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(z.nombreItem, 'Ã¡', 'á'),'Ã©','é'),'Ã­','í'),'Ã³','ó'),'Ãº','ú'),'Ã‰','É'),'ÃŒ','Í'),'Ã“','Ó'),'Ãš','Ú'),'Ã±','ñ'),'Ã‘','Ñ'),'&#039;',' ` '),'Ã','Á'),'',' '),'Ã','Á'),'SI','SI'),'â€œ',''),'â€',''),'Á²','ó') AS nombreItem,a.tipoFinanciamiento,a.nombreEvento,(SELECT a1.nombreDeporte FROM poa_deporte AS a1 WHERE a1.idDeporte=a.Deporte) AS nombreDeporte,(SELECT a1.nombreProvincia FROM in_md_provincias AS a1 WHERE a1.idProvincia=a.provincia) AS nombreProvincia,(SELECT a1.paisnombre FROM poa_pais AS a1 WHERE a1.id=a.ciudadPais) AS paisNombre, (SELECT a1.nombreAlcanse FROM poa_alcanse AS a1 WHERE a1.idAlcanse=a.alcance) AS alcance,a.fechaInicio,a.fechaFin,a.genero,a.categoria,a.numeroEntreandores,a.numeroAtletas,a.total,a.mBenefici,a.hBenefici,a.justificacionAd,a.canitdarBie,a.detalleBien,a.enero,a.febrero,a.marzo,a.abril,a.mayo,a.junio,a.julio,a.agosto,a.septiembre,a.octubre,a.noviembre,a.diciembre,a.totalElem FROM poa_actdeportivas AS a INNER JOIN poa_programacion_financiera AS b ON a.idProgramacionFinanciera=b.idProgramacionFinanciera INNER JOIN poa_item AS z ON z.idItem=b.idItem WHERE b.idOrganismo='$datos[0]' AND b.idActividad='6' AND a.perioIngreso='$aniosPeriodos__ingesos' ORDER BY idActividad;";
		...
		case "reporteria__actividades__7":
			...
			if (empty($idOrganismo)) {
				...
				$query="SELECT REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(z.nombreItem, 'Ã¡', 'á'),'Ã©','é'),'Ã­','í'),'Ã³','ó'),'Ãº','ú'),'Ã‰','É'),'ÃŒ','Í'),'Ã“','Ó'),'Ãš','Ú'),'Ã±','ñ'),'Ã‘','Ñ'),'&#039;',' ` '),'Ã','Á'),'',' '),'Ã','Á'),'SI','SI'),'â€œ',''),'â€',''),'Á²','ó') AS nombreItem,a.tipoFinanciamiento,a.nombreEvento,(SELECT a1.nombreDeporte FROM poa_deporte AS a1 WHERE a1.idDeporte=a.Deporte) AS nombreDeporte,(SELECT a1.nombreProvincia FROM in_md_provincias AS a1 WHERE a1.idProvincia=a.provincia) AS nombreProvincia,(SELECT a1.paisnombre FROM poa_pais AS a1 WHERE a1.id=a.ciudadPais) AS paisNombre, (SELECT a1.nombreAlcanse FROM poa_alcanse AS a1 WHERE a1.idAlcanse=a.alcance) AS alcance,a.fechaInicio,a.fechaFin,a.genero,a.categoria,a.numeroEntreandores,a.numeroAtletas,a.total,a.mBenefici,a.hBenefici,a.justificacionAd,a.canitdarBie,a.detalleBien,a.enero,a.febrero,a.marzo,a.abril,a.mayo,a.junio,a.julio,a.agosto,a.septiembre,a.octubre,a.noviembre,a.diciembre,a.totalElem FROM poa_actdeportivas AS a INNER JOIN poa_programacion_financiera AS b ON a.idProgramacionFinanciera=b.idProgramacionFinanciera INNER JOIN poa_item AS z ON z.idItem=b.idItem WHERE b.idOrganismo='$datos[0]' AND b.idActividad='7' AND a.perioIngreso='$aniosPeriodos__ingesos' ORDER BY idActividad;";
