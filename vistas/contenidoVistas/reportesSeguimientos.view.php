...
<div class="content-wrapper">
	...
	<div class="season_tabs">
	   ...
	   <div class="season_tab">
	       ...
	       <label for="tab-1">Primer trimestre</label>
	   ...
	   <div class="season_tab">
	       ...
	       <label for="tab-2">Segundo trimestre</label>
	    ...
	    <div class="season_tab">
	       ...
	       <label for="tab-3">Tercer trimestre</label>
	     
	       <div class="season_content row">

	       		<?php if (!empty($reporteTecnicosIII[0][archivo])): ?>
	           
	       		<div class="col col-4 row">

	       			<div class="col col-12 vertical__elementos" >

		       			<a class="text-center" href="<?= $ruta.$reporteTecnicosIII[0][archivo]?>" target="_blank">
	       		...
	       		<?php if (!empty($reporteInfraestructurasIII[0][documentoInfras])): ?>

	       		<div class="col col-4 row">

	       			<div class="col col-12 vertical__elementos">

		       			<a class="text-center" href="documentos/seguimiento/informesInfraestructuras/<?= $reporteInfraestructurasIII[0][documentoInfras]?>" target='_blank'>
	       		...
	       		<?php if (!empty($reporteSeguimientosIII[0][documentos])): ?>
	       			
	       		<div class="col col-4 row">

	       			<div class="col col-12 vertical__elementos">

		       			<a class="text-center" href="documentos/seguimiento/informesSeguimientos/<?= $reporteSeguimientosIII[0][documentos]?>" target="_blank">
	    ...
	    <div class="season_tab">
	       ...
	       <label for="tab-4">Cuarto trimestre</label>
	     
	       <div class="season_content row">

	       		<?php if (!empty($reporteTecnicosIV[0][archivo])): ?>
	       		...
	       		<?php if (!empty($reporteInfraestructurasIV[0][documentoInfras])): ?>

	       		<div class="col col-4 row">

	       			<div class="col col-12 vertical__elementos">

		       			<a class="text-center" href="documentos/seguimiento/informesInfraestructuras/<?= $reporteInfraestructurasIV[0][documentoInfras]?>" target='_blank'>
	       		...
	       		<?php if (!empty($reporteSeguimientosIV[0][documentos])): ?>
	       			
	       		<div class="col col-4 row">

	       			<div class="col col-12 vertical__elementos">

		       			<a class="text-center" href="documentos/seguimiento/informesSeguimientos/<?= $reporteSeguimientosIV[0][documentos]?>" target="_blank">
