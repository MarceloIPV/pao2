...
function modificaciones_valores_disminuye_nuevo(mes, idSueldos) {
	...
	if (total == 0) {
			...
			alertify.set("notifier", "position", "top-center");
			alertify.notify("El total debe ser mayor a 0.", "error", 5, function () { });
		} else {
			{
				$.ajax({
					type: "post",
					...
					success: function (response) {
						...
						if (response == 1) {
							alertify.set("notifier", "position", "top-center");
							alertify.notify("Mes ya ingresado.", "error", 5, function () { });
						}
						if (response == 2) {
							alertify.set("notifier", "position", "top-center");
					...
					error: function () {
						alertify.set("notifier", "position", "top-center");
						alertify.notify("No se guardo correctamente.", "error", 5, function () { });
					}
...
function vacantes(idUsuario) {
	var tabla = $.ajax({
		...
		url: "controladores/modificaciones/vacantes.php",
		dataType: 'text',
		async: false
	}).responseText;
...
function ver_items(idUsuario) {
	...
	if (item == 15415) {
		...
		var tabla = $.ajax({
			...
			url: "controladores/modificaciones/suministros.php",
			dataType: 'text',
			async: false
		}).responseText;
...
function nuevo_suministro(idUsuario, tipoServicio) {
	var tabla = $.ajax({
		...
		url: "controladores/modificaciones/nuevo_suministro.php",
		dataType: 'text',
		async: false
	}).responseText;
...
function suministros_guardar_nuevo(tipoServicio, idUsuario) {
	...
	var tabla = $.ajax({
		...
		url: "controladores/modificaciones/suministros_guardar_nuevo.php",
		dataType: 'text',
		async: false
	}).responseText;
...
function modificacion_origen() {
	...
	var codigo = document.getElementById("codigo__presupuestarios__destino__new").value;
	{
		var tabla = $.ajax({
			type: "post",
			data: { actividad: actividad, codigo: codigo, item: item, meses: meses, monto: monto },
			url: "controladores/modificaciones/modificacionesGuardaOrigen.php",
			dataType: 'text',
			async: false
		}).responseText;
...
function modificacion_destino1() {
	...
	var codigo = document.getElementById("codigo__presupuestarios__destino__new2_O").value;
	{
		var tabla = $.ajax({
			type: "post",
			data: { actividad: actividad, codigo: codigo, item: item, meses: meses, monto: monto },
			url: "controladores/modificaciones/modificacionesGuardaDestino.php",
			dataType: 'text',
			async: false
		}).responseText;
...
function modificaciones_ver() {

	{
		var tabla = $.ajax({
			type: "post",
			data: {},
			url: "controladores/modificaciones/modificaciones_ver.php",
			dataType: 'text',
			async: false
		}).responseText;
...
function modificaciones_ver2() {

	{
		var tabla = $.ajax({
			type: "post",
			data: {},
			url: "controladores/modificaciones/modificaciones_ver_destino.php",
			dataType: 'text',
			async: false
		}).responseText;
...
function graficas() {

	{
		var tabla = $.ajax({
			type: "post",
			data: {},
			url: "controladores/modificaciones/graficas.php",
			dataType: 'text',
			async: false
		}).responseText;
...
function historial_sueldos_salarios() {
	{
		var tabla = $.ajax({
			type: "post",
			data: {},
			url: "controladores/modificaciones/historial_sueldos_salarios.php",
			dataType: 'text',
			cache: false,
			processData: false,
			async: false
...
function destino_sueldo() {

	{
		var tabla = $.ajax({
			type: "post",
			data: {},
			url: "controladores/modificaciones/modificacionesDestino.php",
			dataType: 'text',
			async: false
		}).responseText;
...
function sueldo_eliminar_destino(id) {

	{
		var tabla = $.ajax({
			type: "post",
			data: { id: id },
			url: "controladores/modificaciones/modificacionesDestinoEliminarSueldo.php",
			dataType: 'text',
			async: false
		}).responseText;
...
function sueldo_eliminar_origen(idOrigen) {

	{
		var tabla = $.ajax({
			...
			url: "controladores/modificaciones/modificacionesOrigenEliminarSueldo.php",
			dataType: 'text',
			async: false
		}).responseText;
...
function tabla_total() {
	{
		var tabla = $.ajax({
			type: "post",
			data: {},
			url: "controladores/modificaciones/tabla_total.php",
			dataType: 'text',
			async: false
		}).responseText;
...
function tabla_total_avances() {
	{
		var tabla = $.ajax({
			type: "post",
			data: {},
			url: "controladores/modificaciones/tabla_total_avances.php",
			dataType: 'text',
			async: false
		}).responseText;
...
function envio() {
	{
		var tabla = $.ajax({
			type: "post",
			data: {},
			url: "controladores/modificaciones/modificacionesEnvioEjecutar.php",
			dataType: 'text',
			async: false
		}).responseText;
...
function historial_sueldos_salarios2() {
	{
		var tabla = $.ajax({
			type: "post",
			data: {},
			url: "controladores/modificaciones/historial_sueldos_salarios2.php",
			dataType: 'text',
			cache: false,
			processData: false,
			async: false
...
function historial_sueldos_salarios4() {
	{
		var tabla = $.ajax({
			type: "post",
			data: {},
			url: "controladores/modificaciones/historial_sueldos_salarios4.php",
			dataType: 'text',
			cache: false,
			processData: false,
			async: false
...
function historial_sueldos_salarios5() {
	{
		var tabla = $.ajax({
			type: "post",
			data: {},
			url: "controladores/modificaciones/historial_sueldos_salarios5.php",
			dataType: 'text',
			cache: false,
			processData: false,
			async: false
...
function historial_sueldos_salarios6() {
	{
		var tabla = $.ajax({
			type: "post",
			data: {},
			url: "controladores/modificaciones/historial_sueldos_salarios6.php",
			dataType: 'text',
			cache: false,
			processData: false,
			async: false
...
function cargar_nuevoevento() {
	...
	var origen1 = document.getElementById("actividad__modificaciones__destino__modificaciones2").value;
	{
		...
		var tabla = $.ajax({
			type: "post",
			data: {},
			url: "controladores/modificaciones/boton_nuevo_item.php",
			dataType: 'text',
			cache: false,
			processData: false,
			async: false
...
function guardar_desvinculacion() {
	...
	if (total > total__origen) {
		...
		var tabla = $.ajax({
			...
			url: "controladores/modificaciones/desvinculacion_guardar.php",
			dataType: 'text',
			async: false
		}).responseText;
